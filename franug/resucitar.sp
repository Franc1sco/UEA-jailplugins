...
#define PLUGIN_VERSION "v1.0 by Franc1sco Steam: franug (Made in Spain)"
...
public Action:Mision1(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     //SendPanelToClient(client, "MISION", "Tienes que matar a 3 CTs con pistola USP");
...
public Action:Mision2(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     DrawPanelItem(ScoreReportPanal, "Tienes que matar a 4 CTs con AWP");
...
public Action:Mision4(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     //SendPanelToClient(client, "MISION", "Tienes que matar a 2 CTs con una sola Granada");
     ...
     //ServerCommand("sm_armao hegrenade");
...
public Action:Mision7(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     DrawPanelItem(ScoreReportPanal, "Tienes que matar a 5 CTs con cualquier arma");
...
public Action:Mision8(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     DrawPanelItem(ScoreReportPanal, "Tienes que matar a 2 CTs con cegadoras");
...
public Action:Mision9(Handle:timer, any:client)
{
   ...
   if (IsClientInGame(client) && GetClientTeam(client) == 2)
   {
     ...
     DrawPanelItem(ScoreReportPanal, "Tienes que matar a 3 CTs con pistola p228 (pistola de aviso de CT)");
