...
#define COUNT_TXT "Cuchillos Arrojadizos : %i"
...
public OnPluginStart2() {
	...
	CreateConVar("sm_cssthrowingknives_Fusion_Franug-JailPlugins", VERSION2, NAME, FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
