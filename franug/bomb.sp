...
OnPluginStart13()
{
    ...
    bomb_damage = CreateConVar("bomb_damage", "1000", "Damage ");
	...
	if (GetClientTeam(client) != 1 && IsPlayerAlive(client))
        {
              ...
              {
                 PrintToChat(client, "\x04[SM_Franug-JailPlugins] \x05Tienes que ser un KAMIKAZE EXPLOSIVO para usar este comando!");
              }
        }
        else
        {
            PrintToChat(client, "\x04[SM_Franug-JailPlugins] \x05Tienes que estar VIVO para usarlo!");
        }
}
